...
| COMUNIDAD | `juancitoads.com/comunidad` | ✅ Publicada — logo real · web de la plataforma + Instagram (la marca no tiene WhatsApp) · ⏳ falta la regla en `_redirects` de la web |
