...
| `Comunidad/` | COMUNIDAD — "Emprendemos en Fe y crecemos juntos" (plataforma gratuita de emprendedores cristianos, Panamá) | 🟡 ADN base (documento del cliente 2026-09-24 + logo oficial en el repo): visión (Hechos 4:34-35), misión, 10 valores "ADN del Reino" con versículo, tono devocional-pastoral ("hermano", de tú, todo con cita bíblica), paleta `#0A0A0F`/`#FF8A2E`/`#2F7BFF`, tipografía Cinzel+EB Garamond+Inter. **Marca institucional, no personal** (Nelson Muñoz = vocero). **Gratis, sin WhatsApp ni email de marca.** **Nunca mezclar con Feria del Lente.** Pendiente: público objetivo, competencia, historia, rol de Nelson, naranja/azul canónico (logo ≈`#EE8126`/`#0D56B5` vs declarado). Agente diario activo |
