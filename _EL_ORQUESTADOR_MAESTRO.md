...
| `57Dmc/` | 57DMC — Juan David Arrieta Navarro (marca personal / ministerio: rap cristiano, "Música Bíblica") | ✅ Identidad verificada por el cliente (ADN 2026-09 + logo oficial en el repo): misión/visión, principios, tono, dorado `#D19E03` + negro + blanco, tipografía AGITACIYA (respaldo Staatliches), personas "El que crece" / "El que representa", WhatsApp `+507 6910-3347`. **Sin producto/precios:** conversión = escucha/donación/invitación. **Nunca opinión personal — solo lo que dice la Biblia.** Pendiente menor: validar paleta extendida, SEO con el cliente, master prompts, web caída (`juanarrieta.net`) |
...
| `Rofer Service/` | Rofer Service — Alex Sepúlveda (movimiento de tierra + alquiler/venta de equipo pesado, construcción) | 🟡 ADN base (onboarding 2026-09-08) — posicionamiento (asesoría de 20 años → equipo idóneo), buyer persona, competencia (Transeq/Super Mega Máquinas/Alquimaquina), proceso de venta e **identidad visual confirmada**: azul marino `#152473` + **amarillo de máquina `#FFB400`** (secundario oficial desde 2026-09-15, reemplaza al dorado del onboarding), logo excavadora "R⚙FER SERVICE" ya en el repo. **Trato de usted.** Pendiente: tipografía exacta, web, precios. Agente diario activo |
| `Comunidad/` | COMUNIDAD — "Emprendemos en Fe y crecemos juntos" (plataforma gratuita de emprendedores cristianos, Panamá) | 🟡 ADN base (documento del cliente 2026-09-24 + logo oficial en el repo): visión (Hechos 4:34-35), misión, 10 valores "ADN del Reino" con versículo, tono devocional-pastoral ("hermano", de tú, todo con cita bíblica). **Paleta = la del logo:** negro `#000000` + naranja llama `#EF8229` + azul contorno `#1952A8` + blanco; tipografía Cinzel+EB Garamond+Inter. Email `comunidademprendedores.cec@gmail.com`, sin WhatsApp. **Marca institucional, no personal. Gratis.** **Mismo dueño que Feria del Lente — nunca mezclar nada.** Pendiente: público objetivo, competencia, historia, rol de Nelson. Agente diario activo |
...
publicadas: D'CASA, Baby Caleb, Feria del Lente, 57DMC (con su logo real desde 2026-09-24), Juancito Ads e **Ingeniería KMT**
(2026-09-08, con su identidad visual confirmada) y **COMUNIDAD** (2026-09-24, con su logo); Fotosonido queda fuera hasta tener ADN.
